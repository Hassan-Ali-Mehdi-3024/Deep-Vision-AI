      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100 p-8">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-2xl overflow-hidden">
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 p-8 text-white">
            ...
            <p className="text-purple-100 text-lg">Day 16 - Week 4, Day 1</p>
          </div>
          <div className="p-8">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">
                🎯 Build Your First Neural Network: MNIST Digit Classification
              </h2>
              <p className="text-gray-600 leading-relaxed">
                Complete hands-on project implementing build your first neural network: mnist digit classification. Apply concepts learned 
                in Day 16 to solve real-world problems.
              </p>
            </div>
            <div className="space-y-6">
              
              <Task number="1" title="Load MNIST Dataset">
                <p className="text-gray-700 mb-3">60k training, 10k test images</p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                  <li>Implement load mnist dataset functionality</li>
                  <li>Validate results and ensure correctness</li>
                  <li>Document findings and insights</li>
                </ul>
              </Task>
              <Task number="2" title="Data Preprocessing">
                <p className="text-gray-700 mb-3">Normalize pixel values to [0,1], flatten or reshape</p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              ...
              <Task number="3" title="Build Simple NN">
                <p className="text-gray-700 mb-3">Input layer, 2 hidden layers (128, 64 neurons), output layer</p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                  <li>Implement build simple nn functionality</li>
                  <li>Validate results and ensure correctness</li>
                  <li>Document findings and insights</li>
                </ul>
              </Task>
              <Task number="4" title="Compile Model">
                <p className="text-gray-700 mb-3">Adam optimizer, categorical crossentropy, accuracy metric</p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                  <li>Implement compile model functionality</li>
                  <li>Validate results and ensure correctness</li>
                  <li>Document findings and insights</li>
                </ul>
              </Task>
              <Task number="5" title="Train Model">
                <p className="text-gray-700 mb-3">Fit for 10 epochs, validation split</p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              ...
              <Task number="6" title="Evaluate Performance">
                <p className="text-gray-700 mb-3">Test accuracy, confusion matrix</p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              ...
              <Task number="7" title="Visualize Predictions">
                <p className="text-gray-700 mb-3">Show sample predictions with confidence</p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                  <li>Implement visualize predictions functionality</li>
                  <li>Validate results and ensure correctness</li>
                  <li>Document findings and insights</li>
                </ul>
              </Task>
              <Task number="8" title="Experiment">
                <p className="text-gray-700 mb-3">Try different architectures, activations, optimizers</p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                  <li>Implement experiment functionality</li>
                  <li>Validate results and ensure correctness</li>
                  <li>Document findings and insights</li>
                </ul>
              </Task>
